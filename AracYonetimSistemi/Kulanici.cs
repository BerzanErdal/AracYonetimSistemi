...
{
    public partial class Kulanici : Form
    {
        public Kulanici()
        {
            InitializeComponent();
        ...
        private void Kulanici_Load(object sender, EventArgs e)
        {
                    ...
                    case "Car":
                        {
                            ...
                            ListVehiclesToTreeView(treeView1);
                            MessageBox.Show($"Marka:{yeniArac.Marka} Model:{yeniArac.Model} Başarıyla Eklendi.");
                            textboxtemizle();
                            break;
                        }
        ...
        {
            textBoxMarka.Text = textBoxModel.Text = textBoxYil.Text = textBoxYakit.Text  = comboBoxAracTürü.Text = "";
